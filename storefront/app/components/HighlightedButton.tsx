...
export function HighlightedButton({
  ...
  return (
    <button
      ...
      {...props}
      className={clsx(
        'bg-primary-600 border border-transparent rounded-md py-2 px-4 text-base font-medium text-white',
        'focus:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-primary-300 hover:bg-primary-700',
